...
//				STRING , EXCEPTION, STATIC_MESSAGE
				{ "JH5C4SQDAH5", InvalidHandException.class, ParseStringService.INVALID_HAND_STRING_ERROR_MSG, "More than ten" },
				{ "QC9D2HAHOC", InvalidRankException.class, ParseStringService.INVALID_RANK_CHAR_ERROR_MSG, "Rank O" },
				{ "QC9D2HAHKT", InvalidSuitException.class, ParseStringService.INVALID_SUIT_CHAR_ERROR_MSG,"Suit T" } });
	}
